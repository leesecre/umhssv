(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('rxjs/Subscription'), require('rxjs/add/operator/debounceTime'), require('rxjs/add/operator/map'), require('rxjs/BehaviorSubject')) :
    typeof define === 'function' && define.amd ? define(['exports', '@angular/core', 'rxjs/Subscription', 'rxjs/add/operator/debounceTime', 'rxjs/add/operator/map', 'rxjs/BehaviorSubject'], factory) :
    (factory((global.ng = global.ng || {}, global.ng.lock = global.ng.lock || {}, global.ng.lock.system = global.ng.lock.system || {}),global.ng.core,global.Rx,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.Rx));
}(this, (function (exports,_angular_core,rxjs_Subscription,rxjs_add_operator_debounceTime,rxjs_add_operator_map,rxjs_BehaviorSubject) { 'use strict';
...
var UtilService = /** @class */ (function () {
    ...
    UtilService.prototype.isSubscription = function (subs) {
        return subs && subs.unsubscribe && this.isInstanceOf(rxjs_Subscription.Subscription, subs);
    };
